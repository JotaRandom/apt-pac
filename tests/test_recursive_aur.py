...
from apt_pac import commands, aur
...
class TestRecursiveAur(unittest.TestCase):
    def setUp(self):
        ...
        self.official_patcher = patch('apt_pac.aur.is_in_official_repos', return_value=False)
    ...
    def test_recursive_aur_build_and_cleanup(self):
        ...
        with patch('apt_pac.commands.run_pacman_with_apt_output', return_value=True) as mock_pac_install:
             ...
             self.assertTrue(len(makepkg_calls) >= 2, "Should have called makepkg at least twice")
