...
complete -f -c apt-pac -n '__fish_apt_pac_needs_command' -a help -d 'Show package manpage'
complete -f -c apt-pac -n '__fish_apt_pac_needs_command' -a news -d 'Show Arch Linux news'
